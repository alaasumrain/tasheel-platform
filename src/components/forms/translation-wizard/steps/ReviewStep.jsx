    ...
    <Grid container spacing={4}>
      ...
      <Grid size={12}>
        ...
        >
          ...
          />
          {errors?.consent && <FormHelperText error sx={{ mt: 0.5, ml: 4 }}>{errors.consent.message}</FormHelperText>}
        </Box>
      </Grid>

      {/* What happens next - Full width */}
      <Grid size={12}>
        <Card sx={{ borderRadius: { xs: 2, md: 3 }, boxShadow: '0 8px 24px rgba(15,46,83,0.08)' }}>
          <CardContent sx={{ p: { xs: 2.5, sm: 3, md: 3.5 } }}>
            <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 2 }}>
              What happens next
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.6 }}>
              • Tasheel reviews your files and options.<br />
              • You receive a confirmed quote and timeline.<br />
              • Approve online and the project kicks off immediately.
            </Typography>
          </CardContent>
        </Card>
      </Grid>
